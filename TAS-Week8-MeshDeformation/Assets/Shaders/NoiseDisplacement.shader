// Upgrade NOTE: upgraded instancing buffer 'NoiseDisplacement' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "NoiseDisplacement"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NoiseDisplacement)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Albedo)
#define _Albedo_arr NoiseDisplacement
		UNITY_INSTANCING_BUFFER_END(NoiseDisplacement)
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 normalizeResult14 = normalize( ase_vertex3Pos );
			float mulTime3 = _Time.y * _TimeScale;
			float simplePerlin3D1 = snoise( ( ( normalizeResult14 + mulTime3 ) * _Frequency ) );
			float simplePerlin3D27 = snoise( ( ( _Frequency * _Lacunarity ) * ( normalizeResult14 + mulTime3 ) ) );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float simplePerlin3D27 = snoise( ( ( _Frequency * _Lacunarity ) * ( normalizeResult14 + mulTime3 ) ) );
			float3 temp_output_12_0 = ( ase_vertex3Pos * ( ( simplePerlin3D1 * _Amplitude ) + ( _Amplitude * _Persistence * simplePerlin3D27 ) ) );
			o.Albedo = ( _Albedo_Instance * ( _ShadingColor * (_ShadingDarkness + (length( temp_output_12_0 ) - 0.0) * (_ShadingLightness - _ShadingDarkness) / (1.0 - 0.0)) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16301
474;73;943;435;1089.364;-362.139;1.565534;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1590.418,711.3015;Float;False;Property;_TimeScale;Time Scale;6;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;2;-1601.717,364.9673;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;9;-1065.501,615.6462;Float;False;Property;_Frequency;Frequency;2;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;3;-1375.387,715.8029;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;14;-1318.821,513.6677;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1071.256,909.6046;Float;False;Property;_Lacunarity;Lacunarity;4;0;Create;True;0;0;False;0;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-550.1645,916.1824;Float;False;Property;_Persistence;Persistence;5;0;Create;True;0;0;False;0;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-616.5352,734.3508;Float;False;Property;_Amplitude;Amplitude;3;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-9.073303,187.8206;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;224.6167,205.9684;Float;False;Property;_ShadingDarkness;Shading Darkness;7;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;35;502.2863,76.25009;Float;False;Property;_ShadingColor;Shading Color;1;0;Create;True;0;0;False;0;0.5377358,0.5377358,0.5377358,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;5;806.3332,72.85085;Float;False;InstancedProperty;_Albedo;Albedo;0;0;Create;True;0;0;False;0;0.6320754,0.6320754,0.6320754,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1362.838,504.1443;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;NoiseDisplacement;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A66728FA19FABD2C0C5824A1A9DF29F84CE583B0