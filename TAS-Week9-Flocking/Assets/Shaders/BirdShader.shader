...
Shader "BirdShader"
{
	Properties
	{
		...
		[PerRendererData]_AnimFrequency("Anim Frequency", Float) = 0
		_DistanceScalar("Distance Scalar", Float) = 0
		_Albedo("Albedo", Color) = (0,0,0,0)
		[PerRendererData]_PhaseShift("Phase Shift", Float) = 0
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 appendResult15 = (float4(0.0 , ( sin( ( ( ( _Time.y * 1 ) * _AnimFrequency ) + ( temp_output_17_0 * _AnimPeriod ) + _PhaseShift ) ) * _AnimMagnitude * ( temp_output_17_0 * _DistanceScalar ) ) , 0.0 , 0.0));
...
/*ASEBEGIN
Version=16400
692;73;1096;634;1680.827;-387.1251;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-1246.241,809.6909;Float;False;Property;_AnimFrequency;Anim Frequency;3;1;[PerRendererData];Create;True;0;0;False;0;0;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-1242.041,1030.291;Float;False;Property;_AnimPeriod;Anim Period;2;0;Create;True;0;0;False;0;0;-118.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-1038.544,587.1374;Float;False;Property;_PhaseShift;Phase Shift;7;1;[PerRendererData];Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;8;-845.8434,726.4903;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-942.5618,1065.362;Float;False;Property;_DistanceScalar;Distance Scalar;4;0;Create;True;0;0;False;0;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;16;-646.6955,-203.3074;Float;False;Property;_Albedo;Albedo;5;0;Create;True;0;0;False;0;0,0,0,0;0.03033333,0.02566667,0.042,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=DE03912B6091C59F1E16103AF00B956407511466